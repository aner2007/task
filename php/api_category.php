...
<?php
    ...
    $html5.='<li data-number="'.$value->_embedded->{"wp:term"}[0][0]->id.'>"><div class="post-main"><img src='.$value->_embedded->{"wp:featuredmedia"}[0]->source_url.' class="post-images" width=350 height=250>';
        ...
        $html4.='<li data-number="'.$value->_embedded->{"wp:term"}[0][0]->id.'>"><div class="post-main"><img src='.$value->_embedded->{"wp:featuredmedia"}[0]->source_url.' class="post-images" width=350 height=250>';
        ...
        $html3.='<li data-number="'.$value->_embedded->{"wp:term"}[0][0]->id.'>"><div class="post-main"><img src='.$value->_embedded->{"wp:featuredmedia"}[0]->source_url.' class="post-images" width=350 height=250>';
    ...
    $html6.='<li data-number="'.$value->_embedded->{"wp:term"}[0][0]->id.'>"><div class="post-main"><img src='.$value->_embedded->{"wp:featuredmedia"}[0]->source_url.' class="post-images" width=350 height=250>';
    ...
    $html.='<li data-number="0"><div class="post-main"><img src='.$value->_embedded->{"wp:featuredmedia"}[0]->source_url.' class="post-images" width=350 height=250>';
